#url https://clever-mirror-default-rtdb.firebaseio.com
...
def firbase():
    data = res.json()
    temp1 = data['main']['temp']
    myDB = firbase.FirebaseApplication("https://clever-mirror-default-rtdb.firebaseio.com/", None)
    
    data1 = {
        "Name": temp1
        }
    
    myDB.post("weather", data1)
